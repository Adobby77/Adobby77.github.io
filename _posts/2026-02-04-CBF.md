...
categories: study
featured: true
pdf: Control Barrier Function.pdf
---
> [!TIP]
...
>     <i class="fas fa-history"></i> Last updated: {{ page.updated | date: "%b %d, %Y" }}
>   </span>
> </div>
...
> 
> By letting $r=1$, then $\eta_b(x)=h(x)$ and hence
>
> $$\mu=-K_\al\eta_b(x)=-K_\al h(x)=-\al(h(x))$$
>
> where $\al(s)=K_\al s\in\text{class }\mathcal{K}_\infty$.
